...
import { normalizeForMatch, normalizeText, sha256Hex } from '@/domain/rules-sync/normalize'
import type { ParseResult, ParsedEpisode, ParsedScore } from './types'
...
export function parseAltScores(alt: string): { ok: true; scores: ParsedScore[] } | { ok: false; code: 'malformed_alt' | 'duplicate_names' | 'empty_episode'; detail: string } {
